...
class RoomGrid(MiniGridEnv):
    ...
    def place_in_room(self, i, j, obj, pos = None):
        """
    ...
    def add_object(self, i, j, kind=None, color=None, pos=None):
        """
        ...
        return self.place_in_room(i, j, obj, pos)

    def add_door(self, i, j, door_idx=None, color=None, locked=None, pos=None):
        """
    ...
    def place_agent(self, i=None, j=None, rand_dir=True, pos=None, dir = 0):
        """
        ...
        if pos is not None:
            super().place_agent(room.top, room.size, False, max_tries = 0, pos = pos, dir = dir)
            pos = self.start_pos
        else:
